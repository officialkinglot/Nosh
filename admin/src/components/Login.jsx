...
const Login = ({ handleLogin }) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        handleLogin(isAdmin, name, phone, sessionId); // Pass the login type, name, phone, and sessionId to handleLogin
        ...
        const sessionId = generateUniqueId();
        handleLogin(false, name, phone, sessionId); // Pass the login type, name, phone, and sessionId to handleLogin
      } else {
  ...
  useEffect(() => {
    ...
    const isDispatchLoggedIn = localStorage.getItem("isDispatchLoggedIn");
    if (isAdminLoggedIn === "true") {
      navigate("/orders");
    } else if (isDispatchLoggedIn === "true") {
